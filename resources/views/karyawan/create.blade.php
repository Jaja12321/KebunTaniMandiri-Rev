...
<div class="container" style="max-width: 650px;">
    ...
    @enderror
                ...
                <div class="form-group mt-3" id="jabatan-lainnya" style="display:none;">
                    ...
                    <input type="text" class="form-control @error('jabatan_lain') is-invalid @enderror" id="jabatan_lain" name="jabatan_lain" value="{{ old('jabatan_lain') }}" placeholder="Masukkan jabatan lainnya">
                    @error('jabatan_lain')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                        <option value="Harian" {{ old('status') == 'Harian' ? 'selected' : '' }}>Harian</option>
...
<script>
    ...
    // Jika "Lainnya" dipilih saat form dimuat, tampilkan input
